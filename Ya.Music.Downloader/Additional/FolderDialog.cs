...
namespace Microsoft.Win32
{
    public sealed class FolderBrowserDialog : CommonDialog
    {
        ...
        protected override bool RunDialog(IntPtr hwndOwner)
        {
            ...
            try
            {
                SHGetFolderLocation(hwndOwner, (int)RootFolder, IntPtr.Zero, 0, out pidlRoot);

                var dialogOptions = _dialogOptions;

                if (ShowNewFolderButton == false)
                {
                    dialogOptions |= FolderBrowserOptions.HideNewFolderButton;
                }
